...
{
  uint8_t dest_address = l_address;

  char str[4];
  sprintf(str, "%d", l_address);

  char l_msgStr[strlen(Message)+3];

  strcpy(l_msgStr,Message);
  strcat(l_msgStr,  str);
  //////////////////////////////////////////////////////////////////////////////////
  // Transmit a packet continuously with a pause of "waitPeriod"
  if (ConfigOK == 1)
...
//	my_printf("\r\n START SEND\r\n\n");
    ...
    e = BSP_SX1272_sendPacketTimeout(dest_address,l_msgStr,WaitTxMax);
//    my_printf("\r\n END SEND\r\n\n");
...
//	  my_printf("\n \r\n");
    ...
    my_printf("StatRXMsg = %d",StatusRXMessage);
    my_printf(" ; ");
